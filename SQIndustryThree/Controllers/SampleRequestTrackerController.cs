...
{
    public class SampleRequestTrackerController : Controller
    {
        // GET: Vehicle
        SampleRequestTrackerDAL sampleRequestTrackerDAL = new SampleRequestTrackerDAL();
        ...
        public ActionResult Index()
        {
            ...
            return base.RedirectToAction("Index", "SampleRequestTracker");
        }
        ...
        public ActionResult ApproverListBuyerBased(int buyer)
        {
            if (base.Session["SQuserId"] == null)
            {
            ...
            list = this.sampleRequestTrackerDAL.GetApproverBuyerBased(userID, buyer);
        ...
        {
            return Json(sampleRequestTrackerDAL.LoadSeason(), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult LoadSampleStage()
        {
            return Json(sampleRequestTrackerDAL.LoadSampleStage(), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult LoadWashType()
        {
            return Json(sampleRequestTrackerDAL.LoadWashType(), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult LoadGauge()
        {
            return Json(sampleRequestTrackerDAL.LoadGauge(), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        ...
        [HttpPost]
        public ActionResult LoadDepartment(int buyer)
        {
            return Json(sampleRequestTrackerDAL.LoadDepartment(buyer), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        public ActionResult LoadSampleType(int buyer)
        {
            return Json(sampleRequestTrackerDAL.LoadSampleType(buyer), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        ...
        public ActionResult SRTLoadBuyer()
        {
            int userid = Convert.ToInt32(Session["SQuserId"]);
            return Json(sampleRequestTrackerDAL.LoadBuyerList(), JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        ...
        public ActionResult VehicleAllocateForUsers(VehicleAllocationMaster data)
        {
            ...
            int VehicleAllocationMasterId = vehicleDAL.AllocateVehicleForUserFromMaster(data);

            return Json(vehicleDAL.SendEmail(VehicleAllocationMasterId), JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult GetCourierBudgetCheck(int business_unit, string financialYear, int month)
        {
            ...
            var dataGet = vehicleDAL.GetCourierBudgetCheck(business_unit, financialYear, month);
            return Json(new { data = dataGet });

        }
        public ActionResult VehicleReportView()
        {
            if (Session["SQuserId"] == null)
            {
                return RedirectToAction("Index", "Account");
        ...
        [HttpPost]
        public ActionResult GetVehicleReportList(string FromDate, string ToDate, int Location, int BusinessUnit, string TripType)
        {
            if (Session["SQuserId"] == null)
            {
                return RedirectToAction("Index", "Account");
            ...
            int userID = Convert.ToInt32(Session["SQuserId"].ToString());
            return PartialView("_vehicleReportAllList", vehicleDAL.AllVehicleReportList(FromDate, ToDate, Location, BusinessUnit, TripType));
        }
        [HttpPost]
        public ActionResult VehicleRequestDetailsAllocation(int MasterID, string ViewName, int Status)
        {
            if (Session["SQuserId"] == null)
            {
                return RedirectToAction("Index", "Account");
            ...
            int userID = Convert.ToInt32(Session["SQuserId"].ToString());
            VehicleRequestModel iOURequest = vehicleDAL.VehicleRequestDetailsAllocation(MasterID, userID);
            iOURequest.Status = Status;
            return PartialView(ViewName, iOURequest);
        }
    }
