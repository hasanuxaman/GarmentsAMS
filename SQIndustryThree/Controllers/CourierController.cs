...
namespace SQIndustryThree.Controllers
{
    public class CourierController : Controller
    {
        ...
        public ActionResult CourierReportView()
        {
            if (Session["SQuserId"] == null)
            {
                return RedirectToAction("Index", "Account");
        ...
        [HttpPost]
        public ActionResult GetCourierReportList(string FromDate, string ToDate, int BusinessUnit, string CourierType)
        {
            if (Session["SQuserId"] == null)
            {
                return RedirectToAction("Index", "Account");
            ...
            int userID = Convert.ToInt32(Session["SQuserId"].ToString());
            return PartialView("_courierReportAllList", courierDAL.AllCourierReportList(FromDate, ToDate, BusinessUnit, CourierType));
        }
    }
}