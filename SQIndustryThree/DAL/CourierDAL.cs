...
namespace SQIndustryThree.DAL
{
  ...
  int Pgress)
        ...
        public List<CourierRequestModel> AllCourierReportList(string formDate, string todate, int Bun, string CourierType)
        {
            List<CourierRequestModel> users = new List<CourierRequestModel>();
            try
            {
                accessManager.SqlConnectionOpen(DataBase.SQQeye);
                List<SqlParameter> aList = new List<SqlParameter>();
                ...
                aList.Add(new SqlParameter("@CourierType", CourierType));
                //aList.Add(new SqlParameter("@ExceptionType", extype));
                //aList.Add(new SqlParameter("@ReasonCatagory", resonTyp));
                //aList.Add(new SqlParameter("@UserId", UserId));
                SqlDataReader dr = accessManager.GetSqlDataReader("sp_GetCourierReport", aList);
                while (dr.Read())
                {
                    CourierRequestModel exceptionList = new CourierRequestModel();
                    exceptionList.CourierRequestId = (int)dr["CourierRequestId"];
                    exceptionList.CourierType = dr["CourierType"].ToString();
                    exceptionList.IsApproved = (int)dr["IsApproved"];
                    exceptionList.Country = dr["Country"].ToString();
                    exceptionList.CountryName = dr["CountryName"].ToString();
                    exceptionList.ProductDescription = dr["ProductDescription"].ToString();
                    exceptionList.Weight = dr["Weight"].ToString();
                    exceptionList.ServiceProvider = dr["ServiceProvider"].ToString();
                    exceptionList.Cost = dr["Cost"].ToString();
