...
namespace SQIndustryThree.DataManager
{
    public class DataAccessManager
    {
        ...
        public int ReturnPrimaryKey(string StoreProcedure/* /*List<SqlParameter> SqlParameterList,*//* bool IsBigData = false*/)
        {
            int primaryKey = 0;
            try
            {
                primaryKey = ExecuteNonQueryDataPrimariKey(StoreProcedure/* SqlParameterList, true, IsBigData*/);
            }
            catch (SqlException sqlException)
            {
                throw sqlException;
        ...
        private int ExecuteNonQueryDataPrimariKey(string StoreProcedure/*, List<SqlParameter> SqlParameterList, bool IsPrimaryKey = true, bool IsBigData = false*/)
        {
            int primaryKey = 0;
            try
            {
